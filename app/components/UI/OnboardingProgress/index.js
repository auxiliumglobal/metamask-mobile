...
export default class OnboardingProgress extends PureComponent {
	...
	customStyles = {
		...
		labelSize: 10,
		currentStepLabelColor: colors.auxPrimary,
		finishedStepLabelColor: colors.auxPrimary
	};
